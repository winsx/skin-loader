package net.gility.android.skin.demo.fragment;
...
import net.gility.android.skin.demo.activity.DetailActivity;
import net.gility.android.skin.demo.activity.SettingActivity;
import net.gility.android.skin.demo.entity.News;
import net.gility.android.skin.base.BaseFragment;
import net.gility.android.skin.entity.AttrFactory;
import net.gility.android.skin.entity.DynamicAttr;
import net.gility.android.skin.util.CommonBaseAdapter;
import net.gility.android.skin.util.CommonViewHolder;
